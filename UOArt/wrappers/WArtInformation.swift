...
class WArtInformation : NSObject {
    ...
    var information : ArtInformation = ArtInformation()
    ...
    @objc dynamic var weight:Int {
        get {
            return information.weight
        }
        set {
            information.weight = newValue
        }
    }
    
    @objc dynamic var quality:Int {
        get {
            return information.quality
        }
        set {
            information.quality = newValue
        }
    }
    @objc dynamic var miscData:Int {
        get {
            return information.miscData
        }
        set {
            information.miscData = newValue
        }
    }
    @objc dynamic var unknown2:Int {
        get {
            return information.unknown2
        }
        set {
            information.unknown2 = newValue
        }
    }
    @objc dynamic var quantity:Int {
        ...
        set {
            information.quantity = newValue
        }
    }
    @objc dynamic var animID:Int {
        get {
            return information.animID
        }
        set {
            information.animID = newValue
        }
    }
    @objc dynamic var unknown3:Int {
        get {
            return information.unknown3
        }
        set {
            information.unknown3 = newValue
        }
    }
    @objc dynamic var hue:Int {
        get {
            return information.hue
        }
        set {
            information.hue = newValue
        }
    }
    @objc dynamic var stackingOffset:Int {
        get {
            return information.stackingOffset
        }
        set {
            information.stackingOffset = newValue
        }
    }
    @objc dynamic var height:Int {
        ...
        set {
            information.height = newValue
        }
    }
    
    
}
extension WArtInformation : WInformation {
    
    convenience init(artInfo: ArtInformation) {
        self.init()
        information = artInfo
    }
